...
import { c as useRoute, d as useHead, a as __nuxt_component_0$1 } from './server.mjs';
import { u as useAsyncData } from './asyncData-DvozhPju.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { buildCalculatorGraph, getRelatedCalculators } = ([__temp, __restore] = withAsyncContext(() => import('./seoGraph-99f5cfGN.mjs')), __temp = await __temp, __restore(), __temp);
...
//# sourceMappingURL=_slug_-B4puOsCm.mjs.map
