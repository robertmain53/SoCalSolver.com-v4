...
const _lazy_YnTiFv = () => import('../routes/api/__i18n-warmup__.mjs');
const _lazy_ps7GBW = () => import('../routes/api/admin/analytics.get.mjs');
const _lazy_376OiF = () => import('../routes/api/admin/generate-edu.post.mjs');
const _lazy_u7lv3k = () => import('../routes/api/admin/improve-section.post.mjs');
const _lazy_Oykd8_ = () => import('../routes/api/admin/list.get.mjs');
const _lazy_oyqqE6 = () => import('../routes/api/admin/load-educational.mjs');
const _lazy_1B4caC = () => import('../routes/api/admin/save-educational.mjs');
const _lazy_4e2K9c = () => import('../routes/api/admin/save-section.post.mjs');
...
const _lazy_2BJiS6 = () => import('../routes/api/challenge/count.get.mjs');
const _lazy_Ycag0o = () => import('../routes/api/feedback.post.mjs');
const _lazy_yFiRPu = () => import('../routes/api/improve.post.mjs');
const _lazy_pAldn_ = () => import('../routes/api/log-usage.post.mjs');
const _lazy_FQTqsN = () => import('../routes/api/related/_slug_.mjs');
const _lazy_WE1TNA = () => import('../routes/api/review.post.mjs');
const _lazy_vcOX_o = () => import('../routes/api/translation-suggest.post.mjs');
const _lazy_VNLWsT = () => import('../routes/api/user/profile.mjs');
const _lazy_UigGVA = () => import('../routes/sitemap.xml.mjs');
...
const handlers = [
  ...
  { route: '/api/admin/improve-section', handler: _lazy_u7lv3k, lazy: true, middleware: false, method: "post" },
  { route: '/api/admin/list', handler: _lazy_Oykd8_, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/load-educational', handler: _lazy_oyqqE6, lazy: true, middleware: false, method: undefined },
  { route: '/api/admin/save-educational', handler: _lazy_1B4caC, lazy: true, middleware: false, method: undefined },
  { route: '/api/admin/save-section', handler: _lazy_4e2K9c, lazy: true, middleware: false, method: "post" },
  ...
  { route: '/api/challenge/count', handler: _lazy_2BJiS6, lazy: true, middleware: false, method: "get" },
  { route: '/api/feedback', handler: _lazy_Ycag0o, lazy: true, middleware: false, method: "post" },
  { route: '/api/improve', handler: _lazy_yFiRPu, lazy: true, middleware: false, method: "post" },
  { route: '/api/log-usage', handler: _lazy_pAldn_, lazy: true, middleware: false, method: "post" },
  { route: '/api/related/:slug', handler: _lazy_FQTqsN, lazy: true, middleware: false, method: undefined },
  { route: '/api/review', handler: _lazy_WE1TNA, lazy: true, middleware: false, method: "post" },
  { route: '/api/translation-suggest', handler: _lazy_vcOX_o, lazy: true, middleware: false, method: "post" },
  { route: '/api/user/profile', handler: _lazy_VNLWsT, lazy: true, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _lazy_UigGVA, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_S6jqZO, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_S6jqZO, lazy: true, middleware: false, method: undefined }
];
